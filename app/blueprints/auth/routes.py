...
from app.blueprints.auth.views import LoginAPI, LogoutAPI, ProtectedAPI, RegisterAPI, ProtectedRouteAPI
...
auth_bp.add_url_rule("/protected_route", view_func=protected_route_view, methods=["GET"])
